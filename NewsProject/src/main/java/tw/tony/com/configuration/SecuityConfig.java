...
////		.maximumSessions(1);
//
//		http.authorizeRequests().antMatchers("/").hasAnyRole("S", "A", "B", "C", "D").and().formLogin()
//				.loginPage("/login").loginProcessingUrl("/API_login").defaultSuccessUrl("/index")
//				.failureUrl("/login?error=true").permitAll().and().logout().logoutUrl("/perform_logout")
